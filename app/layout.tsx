...
import { Courgette, Barlow, Cabin, Inter } from 'next/font/google';
import './globals.css';
...
const button = Inter({ weight: '500', subsets: ['latin'], variable: '--font-button', display: 'swap' });
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) { return <html lang="en"><body className={`${script.variable} ${sans.variable} ${greeting.variable} ${button.variable}`}>{children}</body></html>; }
