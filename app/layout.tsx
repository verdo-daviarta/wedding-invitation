...
export const metadata: Metadata = { title: 'V / I â€” Wedding Invitation', description: 'Join us to celebrate a new chapter filled with love, laughter, and a brighter tomorrow.' };
